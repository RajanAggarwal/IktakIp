  ...
  <div class="page-title">
    ...
    <div class="clearfix"></div>
     <div class="row">
        ...
        @endif
        <form role="form" id="editUserForm" method="post" action="{!! url('/'.$formAction,base64_encode(convert_uuencode($employerID))) !!}" >
                    {{ csrf_field() }}
                   ...
                   <div class="col-lg-6">
                    ...
                    <a href="{{ url('list_employees',base64_encode(convert_uuencode($employerID)))}}" class="btn btn-danger">Cancel</a>
                 </div>
